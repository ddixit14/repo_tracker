...
echo "| Repository | Open Issues | Open Pull Requests |" > results.md
echo "|------------|-------------|--------------------|" >> results.md

for repository in $(cat java_repositories.txt); do
...
#  fi
  ...
  echo "| $repository | $open_issues_count | $open_pull_requests |" >> results.md
